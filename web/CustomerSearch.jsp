            ...
            <table class="table">
                ...
                <%
                    ...
                    try {
                        ...
                        String query =
"SELECT P.CustomerId, A.AuctionID, A.BidIncrement, A.MinimumBid, A.Copies_Sold, "+
"I.ItemID, I.Description, I.Name, I.Type, I.NumCopies, P.ExpireDate "+
"FROM Auction A, Item I, Post P "+
"WHERE I.ItemID = A.ItemID AND P.AuctionID = A.AuctionID "+
 "AND (P.CustomerID LIKE ? OR I.Type LIKE ? OR I.Name LIKE ? ) "+
 "AND P.AuctionID NOT IN (Select AuctionID From Sale);";
